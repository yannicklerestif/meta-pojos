package com.yannicklerestif.metapojos.misc;
...
public class ClassLoaderTest {
    public static void main(String... args) throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException, InterruptedException {
        URL url = ClassLoaderTest.class.getProtectionDomain().getCodeSource().getLocation();
        final String className = ClassLoaderTest.class.getPackage().getName() + ".UtilityClass";
        {
            ClassLoader cl;
            Class clazz;
    ...
    private static class CustomClassLoader extends URLClassLoader {
        ...
        protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
            try {
                ...
                return Class.forName(name, resolve, ClassLoaderTest.class.getClassLoader());
            }
        }
