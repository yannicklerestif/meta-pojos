 ...
 * @since 3.3
 */
public class MetaPojosLaunchShortcut extends JavaLaunchShortcut {
	...
	protected ILaunchConfigurationType getConfigurationType() {
		return getLaunchManager().getLaunchConfigurationType(MetaPojosLaunchConfigurationDelegate.LAUNCHER_ID);		
	}
